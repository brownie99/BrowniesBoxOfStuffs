...
{
    public class BurntToast : ModProjectile
    {
		...
		public override void AI()
		{
			...
			Lighting.AddLight(projectile.position, 0.8f, 0.2f, 0f);
			int dust1 = Dust.NewDust(projectile.position, 40, 40, 6, 0f, 0f, 0, default(Color), 1.3f);			
